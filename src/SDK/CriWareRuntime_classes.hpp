...
public:
	...
	TMulticastInlineDelegate<void(class UAtomComponent* AtomComponent, struct FAtomBeatSyncInfo& BeatSyncInfo)> OnAtomBeatSyncCallback;                            // 0x11A0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class UAtomComponent* AtomComponent, struct FAtomSequenceInfo& SequenceInfo)> OnAtomSequenceCallback;                            // 0x11B0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAtomComponent) == 0x001240, "Wrong size on UAtomComponent");
...
static_assert(offsetof(UAtomComponent, PlayWorld) == 0x0002A0, "Member 'UAtomComponent::PlayWorld' has a wrong offset!");
static_assert(offsetof(UAtomComponent, GameViewport) == 0x0002A8, "Member 'UAtomComponent::GameViewport' has a wrong offset!");
static_assert(offsetof(UAtomComponent, DefaultSoundObject) == 0x0002D8, "Member 'UAtomComponent::DefaultSoundObject' has a wrong offset!");
static_assert(offsetof(UAtomComponent, AttenuationSettings) == 0x0002E8, "Member 'UAtomComponent::AttenuationSettings' has a wrong offset!");
static_assert(offsetof(UAtomComponent, AttenuationOverrides) == 0x0002F0, "Member 'UAtomComponent::AttenuationOverrides' has a wrong offset!");
static_assert(offsetof(UAtomComponent, CueSheet) == 0x001160, "Member 'UAtomComponent::CueSheet' has a wrong offset!");
static_assert(offsetof(UAtomComponent, AppliedSoundObject) == 0x001178, "Member 'UAtomComponent::AppliedSoundObject' has a wrong offset!");
static_assert(offsetof(UAtomComponent, OnAtomBeatSyncCallback) == 0x0011A0, "Member 'UAtomComponent::OnAtomBeatSyncCallback' has a wrong offset!");
static_assert(offsetof(UAtomComponent, OnAtomSequenceCallback) == 0x0011B0, "Member 'UAtomComponent::OnAtomSequenceCallback' has a wrong offset!");
...
static_assert(sizeof(UCriWarePluginSettings) == 0x0004B8, "Wrong size on UCriWarePluginSettings");
...
static_assert(offsetof(UCriWarePluginSettings, UseDecoderOutputBuffers) == 0x000332, "Member 'UCriWarePluginSettings::UseDecoderOutputBuffers' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, InitializeAdxLipSync) == 0x000334, "Member 'UCriWarePluginSettings::InitializeAdxLipSync' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, MaxNumAnalyzerHandles) == 0x000338, "Member 'UCriWarePluginSettings::MaxNumAnalyzerHandles' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, bUseManaStartupMovies) == 0x000340, "Member 'UCriWarePluginSettings::bUseManaStartupMovies' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, bWaitForMoviesToComplete) == 0x000341, "Member 'UCriWarePluginSettings::bWaitForMoviesToComplete' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, bMoviesAreSkippable) == 0x000342, "Member 'UCriWarePluginSettings::bMoviesAreSkippable' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, StartupMovies) == 0x000348, "Member 'UCriWarePluginSettings::StartupMovies' has a wrong offset!");
