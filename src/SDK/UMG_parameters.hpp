...
// Function UMG.Widget.GetCulledTick
// 0x0001 (0x0001 - 0x0000)
struct Widget_GetCulledTick final
{
public:
	bool                                          ReturnValue;                                       // 0x0000(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(Widget_GetCulledTick) == 0x000001, "Wrong alignment on Widget_GetCulledTick");
static_assert(sizeof(Widget_GetCulledTick) == 0x000001, "Wrong size on Widget_GetCulledTick");
static_assert(offsetof(Widget_GetCulledTick, ReturnValue) == 0x000000, "Member 'Widget_GetCulledTick::ReturnValue' has a wrong offset!");
...
// Function UMG.Widget.SetCulledTick
// 0x0001 (0x0001 - 0x0000)
struct Widget_SetCulledTick final
{
public:
	bool                                          bInCulledTick;                                     // 0x0000(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(Widget_SetCulledTick) == 0x000001, "Wrong alignment on Widget_SetCulledTick");
static_assert(sizeof(Widget_SetCulledTick) == 0x000001, "Wrong size on Widget_SetCulledTick");
static_assert(offsetof(Widget_SetCulledTick, bInCulledTick) == 0x000000, "Member 'Widget_SetCulledTick::bInCulledTick' has a wrong offset!");
