...
public:
	struct FSpDebugModelViewerModelHandle         InHandle;                                          // 0x0000(0x0008)(Parm, NativeAccessSpecifierPublic)
	class USpDebugModelViewerModelCtrlComponent*  ReturnValue;                                       // 0x0008(0x0008)(ExportObject, Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FSpDebugModelViewerModelHandle         ReturnValue;                                       // 0x0040(0x0008)(Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)
...
static_assert(sizeof(SpDebugModelViewerSpawnCtrlComponent_CreateModel) == 0x000050, "Wrong size on SpDebugModelViewerSpawnCtrlComponent_CreateModel");
...
static_assert(offsetof(SpDebugModelViewerSpawnCtrlComponent_CreateModel, ReturnValue) == 0x000040, "Member 'SpDebugModelViewerSpawnCtrlComponent_CreateModel::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(SpRuntimeBlueprintLibrary_CreateViewportCaptureSoftTexture) == 0x000028, "Wrong size on SpRuntimeBlueprintLibrary_CreateViewportCaptureSoftTexture");
...
static_assert(alignof(SpTextBlock_SetShadowOffset) == 0x000004, "Wrong alignment on SpTextBlock_SetShadowOffset");
static_assert(sizeof(SpTextBlock_SetShadowOffset) == 0x000008, "Wrong size on SpTextBlock_SetShadowOffset");
...
static_assert(alignof(SpTextBlock_SetStrikeBrush) == 0x000008, "Wrong alignment on SpTextBlock_SetStrikeBrush");
static_assert(sizeof(SpTextBlock_SetStrikeBrush) == 0x000088, "Wrong size on SpTextBlock_SetStrikeBrush");
...
{
public:
	struct FVector2D                              LeftTop;                                           // 0x0000(0x0008)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector2D                              RightTop;                                          // 0x0008(0x0008)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector2D                              LeftBottom;                                        // 0x0010(0x0008)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector2D                              RightBottom;                                       // 0x0018(0x0008)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(SpUICollisionBox_SetCollisionPoint) == 0x000004, "Wrong alignment on SpUICollisionBox_SetCollisionPoint");
static_assert(sizeof(SpUICollisionBox_SetCollisionPoint) == 0x000020, "Wrong size on SpUICollisionBox_SetCollisionPoint");
...
static_assert(offsetof(SpUICollisionBox_SetCollisionPoint, RightTop) == 0x000008, "Member 'SpUICollisionBox_SetCollisionPoint::RightTop' has a wrong offset!");
static_assert(offsetof(SpUICollisionBox_SetCollisionPoint, LeftBottom) == 0x000010, "Member 'SpUICollisionBox_SetCollisionPoint::LeftBottom' has a wrong offset!");
static_assert(offsetof(SpUICollisionBox_SetCollisionPoint, RightBottom) == 0x000018, "Member 'SpUICollisionBox_SetCollisionPoint::RightBottom' has a wrong offset!");
...
public:
	int32                                         InIndex;                                           // 0x0000(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector2D                              LeftTop;                                           // 0x0004(0x0008)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector2D                              RightTop;                                          // 0x000C(0x0008)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector2D                              LeftBottom;                                        // 0x0014(0x0008)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector2D                              RightBottom;                                       // 0x001C(0x0008)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(SpUIMultiCollisionBox_SetCollisionPoint) == 0x000004, "Wrong alignment on SpUIMultiCollisionBox_SetCollisionPoint");
static_assert(sizeof(SpUIMultiCollisionBox_SetCollisionPoint) == 0x000024, "Wrong size on SpUIMultiCollisionBox_SetCollisionPoint");
...
static_assert(offsetof(SpUIMultiCollisionBox_SetCollisionPoint, LeftTop) == 0x000004, "Member 'SpUIMultiCollisionBox_SetCollisionPoint::LeftTop' has a wrong offset!");
static_assert(offsetof(SpUIMultiCollisionBox_SetCollisionPoint, RightTop) == 0x00000C, "Member 'SpUIMultiCollisionBox_SetCollisionPoint::RightTop' has a wrong offset!");
static_assert(offsetof(SpUIMultiCollisionBox_SetCollisionPoint, LeftBottom) == 0x000014, "Member 'SpUIMultiCollisionBox_SetCollisionPoint::LeftBottom' has a wrong offset!");
static_assert(offsetof(SpUIMultiCollisionBox_SetCollisionPoint, RightBottom) == 0x00001C, "Member 'SpUIMultiCollisionBox_SetCollisionPoint::RightBottom' has a wrong offset!");
...
{
public:
	struct FVector2D                              InPosition;                                        // 0x0000(0x0008)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(SpUIParticle_SetParticlePosition) == 0x000004, "Wrong alignment on SpUIParticle_SetParticlePosition");
static_assert(sizeof(SpUIParticle_SetParticlePosition) == 0x000008, "Wrong size on SpUIParticle_SetParticlePosition");
...
static_assert(alignof(SpUIScrollBox_GetOrientationalContentSize) == 0x000004, "Wrong alignment on SpUIScrollBox_GetOrientationalContentSize");
static_assert(sizeof(SpUIScrollBox_GetOrientationalContentSize) == 0x000008, "Wrong size on SpUIScrollBox_GetOrientationalContentSize");
...
static_assert(alignof(SpUITextParticle_SetParticlePosition) == 0x000004, "Wrong alignment on SpUITextParticle_SetParticlePosition");
static_assert(sizeof(SpUITextParticle_SetParticlePosition) == 0x000008, "Wrong size on SpUITextParticle_SetParticlePosition");
...
static_assert(alignof(SpUIWindow_SetWindowPosition) == 0x000004, "Wrong alignment on SpUIWindow_SetWindowPosition");
static_assert(sizeof(SpUIWindow_SetWindowPosition) == 0x000008, "Wrong size on SpUIWindow_SetWindowPosition");
