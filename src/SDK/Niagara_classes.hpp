...
// Class Niagara.RCNiagaraDataInterfaceActor
// 0x0008 (0x0040 - 0x0038)
class URCNiagaraDataInterfaceActor final : public UNiagaraDataInterface
{
public:
	class UTexture*                               Texture;                                           // 0x0038(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"RCNiagaraDataInterfaceActor">();
	}
	static class URCNiagaraDataInterfaceActor* GetDefaultObj()
	{
		return GetDefaultObjImpl<URCNiagaraDataInterfaceActor>();
	}
};
static_assert(alignof(URCNiagaraDataInterfaceActor) == 0x000008, "Wrong alignment on URCNiagaraDataInterfaceActor");
static_assert(sizeof(URCNiagaraDataInterfaceActor) == 0x000040, "Wrong size on URCNiagaraDataInterfaceActor");
static_assert(offsetof(URCNiagaraDataInterfaceActor, Texture) == 0x000038, "Member 'URCNiagaraDataInterfaceActor::Texture' has a wrong offset!");

// Class Niagara.RCNiagaraPhysixFunctionLibrary
// 0x0000 (0x0028 - 0x0028)
class URCNiagaraPhysixFunctionLibrary final : public UBlueprintFunctionLibrary
{
public:
	static void RCNinagaraMakeGravityMap(class UNiagaraComponent* NiagaraSystem, const struct FVector& Location, class AActor* cap);
	static void RCNinagaraMakeKinZone(class UNiagaraComponent* NiagaraSystem, const struct FVector& Location, class AActor* cap);
	static void RCSetNiagaraVariableTexture(const class UNiagaraComponent* Niagara, const class FString& InVariableName, class UTexture* InValue);

public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"RCNiagaraPhysixFunctionLibrary">();
	}
	static class URCNiagaraPhysixFunctionLibrary* GetDefaultObj()
	{
		return GetDefaultObjImpl<URCNiagaraPhysixFunctionLibrary>();
	}
};
static_assert(alignof(URCNiagaraPhysixFunctionLibrary) == 0x000008, "Wrong alignment on URCNiagaraPhysixFunctionLibrary");
static_assert(sizeof(URCNiagaraPhysixFunctionLibrary) == 0x000028, "Wrong size on URCNiagaraPhysixFunctionLibrary");
