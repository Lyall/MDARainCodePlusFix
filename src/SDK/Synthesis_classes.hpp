...
static_assert(sizeof(USynth2DSlider) == 0x000480, "Wrong size on USynth2DSlider");
static_assert(offsetof(USynth2DSlider, ValueX) == 0x000110, "Member 'USynth2DSlider::ValueX' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, ValueY) == 0x000114, "Member 'USynth2DSlider::ValueY' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, ValueXDelegate) == 0x000118, "Member 'USynth2DSlider::ValueXDelegate' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, ValueYDelegate) == 0x000128, "Member 'USynth2DSlider::ValueYDelegate' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, WidgetStyle) == 0x000138, "Member 'USynth2DSlider::WidgetStyle' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, SliderHandleColor) == 0x0003F0, "Member 'USynth2DSlider::SliderHandleColor' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, IndentHandle) == 0x000400, "Member 'USynth2DSlider::IndentHandle' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, Locked) == 0x000401, "Member 'USynth2DSlider::Locked' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, StepSize) == 0x000404, "Member 'USynth2DSlider::StepSize' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, IsFocusable) == 0x000408, "Member 'USynth2DSlider::IsFocusable' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, OnMouseCaptureBegin) == 0x000410, "Member 'USynth2DSlider::OnMouseCaptureBegin' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, OnMouseCaptureEnd) == 0x000420, "Member 'USynth2DSlider::OnMouseCaptureEnd' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, OnControllerCaptureBegin) == 0x000430, "Member 'USynth2DSlider::OnControllerCaptureBegin' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, OnControllerCaptureEnd) == 0x000440, "Member 'USynth2DSlider::OnControllerCaptureEnd' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, OnValueChangedX) == 0x000450, "Member 'USynth2DSlider::OnValueChangedX' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, OnValueChangedY) == 0x000460, "Member 'USynth2DSlider::OnValueChangedY' has a wrong offset!");
...
static_assert(sizeof(USynthKnob) == 0x000408, "Wrong size on USynthKnob");
static_assert(offsetof(USynthKnob, Value) == 0x000110, "Member 'USynthKnob::Value' has a wrong offset!");
static_assert(offsetof(USynthKnob, StepSize) == 0x000114, "Member 'USynthKnob::StepSize' has a wrong offset!");
static_assert(offsetof(USynthKnob, MouseSpeed) == 0x000118, "Member 'USynthKnob::MouseSpeed' has a wrong offset!");
static_assert(offsetof(USynthKnob, MouseFineTuneSpeed) == 0x00011C, "Member 'USynthKnob::MouseFineTuneSpeed' has a wrong offset!");
static_assert(offsetof(USynthKnob, ParameterName) == 0x000128, "Member 'USynthKnob::ParameterName' has a wrong offset!");
static_assert(offsetof(USynthKnob, ParameterUnits) == 0x000140, "Member 'USynthKnob::ParameterUnits' has a wrong offset!");
static_assert(offsetof(USynthKnob, ValueDelegate) == 0x000158, "Member 'USynthKnob::ValueDelegate' has a wrong offset!");
static_assert(offsetof(USynthKnob, WidgetStyle) == 0x000168, "Member 'USynthKnob::WidgetStyle' has a wrong offset!");
static_assert(offsetof(USynthKnob, Locked) == 0x0003A0, "Member 'USynthKnob::Locked' has a wrong offset!");
static_assert(offsetof(USynthKnob, IsFocusable) == 0x0003A1, "Member 'USynthKnob::IsFocusable' has a wrong offset!");
static_assert(offsetof(USynthKnob, OnMouseCaptureBegin) == 0x0003A8, "Member 'USynthKnob::OnMouseCaptureBegin' has a wrong offset!");
static_assert(offsetof(USynthKnob, OnMouseCaptureEnd) == 0x0003B8, "Member 'USynthKnob::OnMouseCaptureEnd' has a wrong offset!");
static_assert(offsetof(USynthKnob, OnControllerCaptureBegin) == 0x0003C8, "Member 'USynthKnob::OnControllerCaptureBegin' has a wrong offset!");
static_assert(offsetof(USynthKnob, OnControllerCaptureEnd) == 0x0003D8, "Member 'USynthKnob::OnControllerCaptureEnd' has a wrong offset!");
static_assert(offsetof(USynthKnob, OnValueChanged) == 0x0003E8, "Member 'USynthKnob::OnValueChanged' has a wrong offset!");
