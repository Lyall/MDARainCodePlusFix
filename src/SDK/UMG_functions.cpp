...
bool UWidget::GetCulledTick()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Widget", "GetCulledTick");

	Params::Widget_GetCulledTick Parms{};
...
// (Final, BlueprintCosmetic, Native, Public, BlueprintCallable)
// Parameters:
// bool                                    bInCulledTick                                          (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UWidget::SetCulledTick(bool bInCulledTick)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Widget", "SetCulledTick");

	Params::Widget_SetCulledTick Parms{};

	Parms.bInCulledTick = bInCulledTick;
