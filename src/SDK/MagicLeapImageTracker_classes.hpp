...
public:
	...
	TMulticastInlineDelegate<void(struct FVector& LastTrackedLocation, struct FRotator& LastTrackedRotation, struct FVector& NewUnreliableLocation, struct FRotator& NewUnreliableRotation)> OnImageTargetUnreliableTracking;                   // 0x0258(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
