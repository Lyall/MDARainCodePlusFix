...
public:
	...
	bool                                          CulledTick;                                        // 0x0108(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	void SetCulledTick(bool bInCulledTick);
...
static_assert(sizeof(UWidget) == 0x000110, "Wrong size on UWidget");
...
static_assert(offsetof(UWidget, CulledTick) == 0x000108, "Member 'UWidget::CulledTick' has a wrong offset!");
...
static_assert(sizeof(UPanelWidget) == 0x000128, "Wrong size on UPanelWidget");
static_assert(offsetof(UPanelWidget, Slots) == 0x000110, "Member 'UPanelWidget::Slots' has a wrong offset!");
...
static_assert(sizeof(UContentWidget) == 0x000128, "Wrong size on UContentWidget");
...
static_assert(sizeof(UCheckBox) == 0x000778, "Wrong size on UCheckBox");
static_assert(offsetof(UCheckBox, CheckedState) == 0x000128, "Member 'UCheckBox::CheckedState' has a wrong offset!");
static_assert(offsetof(UCheckBox, CheckedStateDelegate) == 0x00012C, "Member 'UCheckBox::CheckedStateDelegate' has a wrong offset!");
static_assert(offsetof(UCheckBox, WidgetStyle) == 0x000140, "Member 'UCheckBox::WidgetStyle' has a wrong offset!");
static_assert(offsetof(UCheckBox, Style) == 0x0006C0, "Member 'UCheckBox::Style' has a wrong offset!");
static_assert(offsetof(UCheckBox, UncheckedImage) == 0x0006C8, "Member 'UCheckBox::UncheckedImage' has a wrong offset!");
static_assert(offsetof(UCheckBox, UncheckedHoveredImage) == 0x0006D0, "Member 'UCheckBox::UncheckedHoveredImage' has a wrong offset!");
static_assert(offsetof(UCheckBox, UncheckedPressedImage) == 0x0006D8, "Member 'UCheckBox::UncheckedPressedImage' has a wrong offset!");
static_assert(offsetof(UCheckBox, CheckedImage) == 0x0006E0, "Member 'UCheckBox::CheckedImage' has a wrong offset!");
static_assert(offsetof(UCheckBox, CheckedHoveredImage) == 0x0006E8, "Member 'UCheckBox::CheckedHoveredImage' has a wrong offset!");
static_assert(offsetof(UCheckBox, CheckedPressedImage) == 0x0006F0, "Member 'UCheckBox::CheckedPressedImage' has a wrong offset!");
static_assert(offsetof(UCheckBox, UndeterminedImage) == 0x0006F8, "Member 'UCheckBox::UndeterminedImage' has a wrong offset!");
static_assert(offsetof(UCheckBox, UndeterminedHoveredImage) == 0x000700, "Member 'UCheckBox::UndeterminedHoveredImage' has a wrong offset!");
static_assert(offsetof(UCheckBox, UndeterminedPressedImage) == 0x000708, "Member 'UCheckBox::UndeterminedPressedImage' has a wrong offset!");
static_assert(offsetof(UCheckBox, HorizontalAlignment) == 0x000710, "Member 'UCheckBox::HorizontalAlignment' has a wrong offset!");
static_assert(offsetof(UCheckBox, Padding) == 0x000714, "Member 'UCheckBox::Padding' has a wrong offset!");
static_assert(offsetof(UCheckBox, BorderBackgroundColor) == 0x000728, "Member 'UCheckBox::BorderBackgroundColor' has a wrong offset!");
static_assert(offsetof(UCheckBox, ClickMethod) == 0x000750, "Member 'UCheckBox::ClickMethod' has a wrong offset!");
static_assert(offsetof(UCheckBox, TouchMethod) == 0x000751, "Member 'UCheckBox::TouchMethod' has a wrong offset!");
static_assert(offsetof(UCheckBox, PressMethod) == 0x000752, "Member 'UCheckBox::PressMethod' has a wrong offset!");
static_assert(offsetof(UCheckBox, IsFocusable) == 0x000753, "Member 'UCheckBox::IsFocusable' has a wrong offset!");
static_assert(offsetof(UCheckBox, OnCheckStateChanged) == 0x000758, "Member 'UCheckBox::OnCheckStateChanged' has a wrong offset!");
...
static_assert(sizeof(UTextLayoutWidget) == 0x000130, "Wrong size on UTextLayoutWidget");
static_assert(offsetof(UTextLayoutWidget, ShapedTextOptions) == 0x000110, "Member 'UTextLayoutWidget::ShapedTextOptions' has a wrong offset!");
static_assert(offsetof(UTextLayoutWidget, Justification) == 0x000113, "Member 'UTextLayoutWidget::Justification' has a wrong offset!");
static_assert(offsetof(UTextLayoutWidget, WrappingPolicy) == 0x000114, "Member 'UTextLayoutWidget::WrappingPolicy' has a wrong offset!");
static_assert(offsetof(UTextLayoutWidget, WrapTextAt) == 0x000118, "Member 'UTextLayoutWidget::WrapTextAt' has a wrong offset!");
static_assert(offsetof(UTextLayoutWidget, Margin) == 0x00011C, "Member 'UTextLayoutWidget::Margin' has a wrong offset!");
static_assert(offsetof(UTextLayoutWidget, LineHeightPercentage) == 0x00012C, "Member 'UTextLayoutWidget::LineHeightPercentage' has a wrong offset!");
...
public:
	...
	class UStaticMesh*                            StaticMesh;                                        // 0x05A0(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	int32                                         WidgetMaterialIndex;                               // 0x05A8(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UWidgetComponent, StaticMesh) == 0x0005A0, "Member 'UWidgetComponent::StaticMesh' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, WidgetMaterialIndex) == 0x0005A8, "Member 'UWidgetComponent::WidgetMaterialIndex' has a wrong offset!");
...
static_assert(sizeof(UExpandableArea) == 0x000340, "Wrong size on UExpandableArea");
static_assert(offsetof(UExpandableArea, Style) == 0x000118, "Member 'UExpandableArea::Style' has a wrong offset!");
static_assert(offsetof(UExpandableArea, BorderBrush) == 0x000238, "Member 'UExpandableArea::BorderBrush' has a wrong offset!");
static_assert(offsetof(UExpandableArea, BorderColor) == 0x0002C0, "Member 'UExpandableArea::BorderColor' has a wrong offset!");
static_assert(offsetof(UExpandableArea, bIsExpanded) == 0x0002E8, "Member 'UExpandableArea::bIsExpanded' has a wrong offset!");
static_assert(offsetof(UExpandableArea, MaxHeight) == 0x0002EC, "Member 'UExpandableArea::MaxHeight' has a wrong offset!");
static_assert(offsetof(UExpandableArea, HeaderPadding) == 0x0002F0, "Member 'UExpandableArea::HeaderPadding' has a wrong offset!");
static_assert(offsetof(UExpandableArea, AreaPadding) == 0x000300, "Member 'UExpandableArea::AreaPadding' has a wrong offset!");
static_assert(offsetof(UExpandableArea, OnExpansionChanged) == 0x000310, "Member 'UExpandableArea::OnExpansionChanged' has a wrong offset!");
static_assert(offsetof(UExpandableArea, HeaderContent) == 0x000320, "Member 'UExpandableArea::HeaderContent' has a wrong offset!");
static_assert(offsetof(UExpandableArea, BodyContent) == 0x000328, "Member 'UExpandableArea::BodyContent' has a wrong offset!");
...
static_assert(offsetof(UComboBox, Items) == 0x000110, "Member 'UComboBox::Items' has a wrong offset!");
static_assert(offsetof(UComboBox, OnGenerateWidgetEvent) == 0x000120, "Member 'UComboBox::OnGenerateWidgetEvent' has a wrong offset!");
static_assert(offsetof(UComboBox, bIsFocusable) == 0x000130, "Member 'UComboBox::bIsFocusable' has a wrong offset!");
...
static_assert(offsetof(UViewport, BackgroundColor) == 0x000128, "Member 'UViewport::BackgroundColor' has a wrong offset!");
...
public:
	...
	bool                                          bScrollLoop;                                       // 0x0860(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UScrollBox) == 0x000890, "Wrong size on UScrollBox");
static_assert(offsetof(UScrollBox, WidgetStyle) == 0x000128, "Member 'UScrollBox::WidgetStyle' has a wrong offset!");
static_assert(offsetof(UScrollBox, WidgetBarStyle) == 0x000350, "Member 'UScrollBox::WidgetBarStyle' has a wrong offset!");
static_assert(offsetof(UScrollBox, Style) == 0x000820, "Member 'UScrollBox::Style' has a wrong offset!");
static_assert(offsetof(UScrollBox, BarStyle) == 0x000828, "Member 'UScrollBox::BarStyle' has a wrong offset!");
static_assert(offsetof(UScrollBox, Orientation) == 0x000830, "Member 'UScrollBox::Orientation' has a wrong offset!");
static_assert(offsetof(UScrollBox, ScrollBarVisibility) == 0x000831, "Member 'UScrollBox::ScrollBarVisibility' has a wrong offset!");
static_assert(offsetof(UScrollBox, ConsumeMouseWheel) == 0x000832, "Member 'UScrollBox::ConsumeMouseWheel' has a wrong offset!");
...
static_assert(offsetof(UScrollBox, bScrollLoop) == 0x000860, "Member 'UScrollBox::bScrollLoop' has a wrong offset!");
static_assert(offsetof(UScrollBox, OnUserScrolled) == 0x000868, "Member 'UScrollBox::OnUserScrolled' has a wrong offset!");
...
public:
	...
	int32                                         Priority;                                          // 0x01E8(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bSupportsKeyboardFocus : 1;                        // 0x01EC(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Deprecated, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bIsFocusable : 1;                                  // 0x01EC(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bStopAction : 1;                                   // 0x01EC(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bChangeSpeed : 1;                                  // 0x01EC(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_1ED[0x3];                                      // 0x01ED(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         SequenceSpeed;                                     // 0x01F0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bHasScriptImplementedTick : 1;                     // 0x01F4(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bHasScriptImplementedPaint : 1;                    // 0x01F4(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
static_assert(sizeof(UUserWidget) == 0x000270, "Wrong size on UUserWidget");
static_assert(offsetof(UUserWidget, ColorAndOpacity) == 0x000118, "Member 'UUserWidget::ColorAndOpacity' has a wrong offset!");
static_assert(offsetof(UUserWidget, ColorAndOpacityDelegate) == 0x000128, "Member 'UUserWidget::ColorAndOpacityDelegate' has a wrong offset!");
static_assert(offsetof(UUserWidget, ForegroundColor) == 0x000138, "Member 'UUserWidget::ForegroundColor' has a wrong offset!");
static_assert(offsetof(UUserWidget, ForegroundColorDelegate) == 0x000160, "Member 'UUserWidget::ForegroundColorDelegate' has a wrong offset!");
static_assert(offsetof(UUserWidget, OnVisibilityChanged) == 0x000170, "Member 'UUserWidget::OnVisibilityChanged' has a wrong offset!");
static_assert(offsetof(UUserWidget, Padding) == 0x000198, "Member 'UUserWidget::Padding' has a wrong offset!");
...
static_assert(offsetof(UUserWidget, AnimationTickManager) == 0x0001B8, "Member 'UUserWidget::AnimationTickManager' has a wrong offset!");
static_assert(offsetof(UUserWidget, StoppedSequencePlayers) == 0x0001C0, "Member 'UUserWidget::StoppedSequencePlayers' has a wrong offset!");
static_assert(offsetof(UUserWidget, NamedSlotBindings) == 0x0001D0, "Member 'UUserWidget::NamedSlotBindings' has a wrong offset!");
static_assert(offsetof(UUserWidget, WidgetTree) == 0x0001E0, "Member 'UUserWidget::WidgetTree' has a wrong offset!");
static_assert(offsetof(UUserWidget, Priority) == 0x0001E8, "Member 'UUserWidget::Priority' has a wrong offset!");
static_assert(offsetof(UUserWidget, SequenceSpeed) == 0x0001F0, "Member 'UUserWidget::SequenceSpeed' has a wrong offset!");
static_assert(offsetof(UUserWidget, TickFrequency) == 0x000200, "Member 'UUserWidget::TickFrequency' has a wrong offset!");
static_assert(offsetof(UUserWidget, InputComponent) == 0x000208, "Member 'UUserWidget::InputComponent' has a wrong offset!");
static_assert(offsetof(UUserWidget, AnimationCallbacks) == 0x000210, "Member 'UUserWidget::AnimationCallbacks' has a wrong offset!");
...
static_assert(sizeof(UBackgroundBlur) == 0x0001E0, "Wrong size on UBackgroundBlur");
static_assert(offsetof(UBackgroundBlur, Padding) == 0x000128, "Member 'UBackgroundBlur::Padding' has a wrong offset!");
static_assert(offsetof(UBackgroundBlur, HorizontalAlignment) == 0x000138, "Member 'UBackgroundBlur::HorizontalAlignment' has a wrong offset!");
static_assert(offsetof(UBackgroundBlur, VerticalAlignment) == 0x000139, "Member 'UBackgroundBlur::VerticalAlignment' has a wrong offset!");
static_assert(offsetof(UBackgroundBlur, bApplyAlphaToBlur) == 0x00013A, "Member 'UBackgroundBlur::bApplyAlphaToBlur' has a wrong offset!");
static_assert(offsetof(UBackgroundBlur, BlurStrength) == 0x00013C, "Member 'UBackgroundBlur::BlurStrength' has a wrong offset!");
static_assert(offsetof(UBackgroundBlur, bOverrideAutoRadiusCalculation) == 0x000140, "Member 'UBackgroundBlur::bOverrideAutoRadiusCalculation' has a wrong offset!");
static_assert(offsetof(UBackgroundBlur, BlurRadius) == 0x000144, "Member 'UBackgroundBlur::BlurRadius' has a wrong offset!");
static_assert(offsetof(UBackgroundBlur, LowQualityFallbackBrush) == 0x000148, "Member 'UBackgroundBlur::LowQualityFallbackBrush' has a wrong offset!");
...
static_assert(sizeof(UOverlay) == 0x000138, "Wrong size on UOverlay");
...
public:
	...
	TDelegate<void(const struct FGeometry& MyGeometry, struct FPointerEvent& MouseEvent)> OnMouseButtonDownEvent;                            // 0x0224(0x0010)(Edit, ZeroConstructor, InstancedReference, NoDestructor, NativeAccessSpecifierPublic)
	TDelegate<void(const struct FGeometry& MyGeometry, struct FPointerEvent& MouseEvent)> OnMouseButtonUpEvent;                              // 0x0234(0x0010)(Edit, ZeroConstructor, InstancedReference, NoDestructor, NativeAccessSpecifierPublic)
	TDelegate<void(const struct FGeometry& MyGeometry, struct FPointerEvent& MouseEvent)> OnMouseMoveEvent;                                  // 0x0244(0x0010)(Edit, ZeroConstructor, InstancedReference, NoDestructor, NativeAccessSpecifierPublic)
	TDelegate<void(const struct FGeometry& MyGeometry, struct FPointerEvent& MouseEvent)> OnMouseDoubleClickEvent;                           // 0x0254(0x0010)(Edit, ZeroConstructor, InstancedReference, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UBorder) == 0x000278, "Wrong size on UBorder");
static_assert(offsetof(UBorder, HorizontalAlignment) == 0x000128, "Member 'UBorder::HorizontalAlignment' has a wrong offset!");
static_assert(offsetof(UBorder, VerticalAlignment) == 0x000129, "Member 'UBorder::VerticalAlignment' has a wrong offset!");
static_assert(offsetof(UBorder, ContentColorAndOpacity) == 0x00012C, "Member 'UBorder::ContentColorAndOpacity' has a wrong offset!");
static_assert(offsetof(UBorder, ContentColorAndOpacityDelegate) == 0x00013C, "Member 'UBorder::ContentColorAndOpacityDelegate' has a wrong offset!");
static_assert(offsetof(UBorder, Padding) == 0x00014C, "Member 'UBorder::Padding' has a wrong offset!");
static_assert(offsetof(UBorder, Background) == 0x000160, "Member 'UBorder::Background' has a wrong offset!");
static_assert(offsetof(UBorder, BackgroundDelegate) == 0x0001E8, "Member 'UBorder::BackgroundDelegate' has a wrong offset!");
static_assert(offsetof(UBorder, BrushColor) == 0x0001F8, "Member 'UBorder::BrushColor' has a wrong offset!");
static_assert(offsetof(UBorder, BrushColorDelegate) == 0x000208, "Member 'UBorder::BrushColorDelegate' has a wrong offset!");
static_assert(offsetof(UBorder, DesiredSizeScale) == 0x000218, "Member 'UBorder::DesiredSizeScale' has a wrong offset!");
static_assert(offsetof(UBorder, bFlipForRightToLeftFlowDirection) == 0x000220, "Member 'UBorder::bFlipForRightToLeftFlowDirection' has a wrong offset!");
static_assert(offsetof(UBorder, OnMouseButtonDownEvent) == 0x000224, "Member 'UBorder::OnMouseButtonDownEvent' has a wrong offset!");
static_assert(offsetof(UBorder, OnMouseButtonUpEvent) == 0x000234, "Member 'UBorder::OnMouseButtonUpEvent' has a wrong offset!");
static_assert(offsetof(UBorder, OnMouseMoveEvent) == 0x000244, "Member 'UBorder::OnMouseMoveEvent' has a wrong offset!");
static_assert(offsetof(UBorder, OnMouseDoubleClickEvent) == 0x000254, "Member 'UBorder::OnMouseDoubleClickEvent' has a wrong offset!");
...
static_assert(sizeof(UButton) == 0x000430, "Wrong size on UButton");
static_assert(offsetof(UButton, Style) == 0x000128, "Member 'UButton::Style' has a wrong offset!");
static_assert(offsetof(UButton, WidgetStyle) == 0x000130, "Member 'UButton::WidgetStyle' has a wrong offset!");
static_assert(offsetof(UButton, ColorAndOpacity) == 0x0003A8, "Member 'UButton::ColorAndOpacity' has a wrong offset!");
static_assert(offsetof(UButton, BackgroundColor) == 0x0003B8, "Member 'UButton::BackgroundColor' has a wrong offset!");
static_assert(offsetof(UButton, ClickMethod) == 0x0003C8, "Member 'UButton::ClickMethod' has a wrong offset!");
static_assert(offsetof(UButton, TouchMethod) == 0x0003C9, "Member 'UButton::TouchMethod' has a wrong offset!");
static_assert(offsetof(UButton, PressMethod) == 0x0003CA, "Member 'UButton::PressMethod' has a wrong offset!");
static_assert(offsetof(UButton, IsFocusable) == 0x0003CB, "Member 'UButton::IsFocusable' has a wrong offset!");
static_assert(offsetof(UButton, OnClicked) == 0x0003D0, "Member 'UButton::OnClicked' has a wrong offset!");
static_assert(offsetof(UButton, OnPressed) == 0x0003E0, "Member 'UButton::OnPressed' has a wrong offset!");
static_assert(offsetof(UButton, OnReleased) == 0x0003F0, "Member 'UButton::OnReleased' has a wrong offset!");
static_assert(offsetof(UButton, OnHovered) == 0x000400, "Member 'UButton::OnHovered' has a wrong offset!");
static_assert(offsetof(UButton, OnUnhovered) == 0x000410, "Member 'UButton::OnUnhovered' has a wrong offset!");
...
static_assert(sizeof(UCanvasPanel) == 0x000138, "Wrong size on UCanvasPanel");
...
public:
	...
	TDelegate<void(const struct FGeometry& MyGeometry, struct FPointerEvent& MouseEvent)> OnMouseButtonDownEvent;                            // 0x01CC(0x0010)(Edit, ZeroConstructor, InstancedReference, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UImage) == 0x000218, "Wrong size on UImage");
static_assert(offsetof(UImage, Brush) == 0x000110, "Member 'UImage::Brush' has a wrong offset!");
static_assert(offsetof(UImage, BrushDelegate) == 0x000198, "Member 'UImage::BrushDelegate' has a wrong offset!");
static_assert(offsetof(UImage, ColorAndOpacity) == 0x0001A8, "Member 'UImage::ColorAndOpacity' has a wrong offset!");
static_assert(offsetof(UImage, ColorAndOpacityDelegate) == 0x0001B8, "Member 'UImage::ColorAndOpacityDelegate' has a wrong offset!");
static_assert(offsetof(UImage, bFlipForRightToLeftFlowDirection) == 0x0001C8, "Member 'UImage::bFlipForRightToLeftFlowDirection' has a wrong offset!");
static_assert(offsetof(UImage, OnMouseButtonDownEvent) == 0x0001CC, "Member 'UImage::OnMouseButtonDownEvent' has a wrong offset!");
...
static_assert(sizeof(UCircularThrobber) == 0x0001C8, "Wrong size on UCircularThrobber");
static_assert(offsetof(UCircularThrobber, NumberOfPieces) == 0x000110, "Member 'UCircularThrobber::NumberOfPieces' has a wrong offset!");
static_assert(offsetof(UCircularThrobber, Period) == 0x000114, "Member 'UCircularThrobber::Period' has a wrong offset!");
static_assert(offsetof(UCircularThrobber, Radius) == 0x000118, "Member 'UCircularThrobber::Radius' has a wrong offset!");
static_assert(offsetof(UCircularThrobber, PieceImage) == 0x000120, "Member 'UCircularThrobber::PieceImage' has a wrong offset!");
static_assert(offsetof(UCircularThrobber, Image) == 0x000128, "Member 'UCircularThrobber::Image' has a wrong offset!");
static_assert(offsetof(UCircularThrobber, bEnableRadius) == 0x0001B0, "Member 'UCircularThrobber::bEnableRadius' has a wrong offset!");
...
public:
	...
	TMulticastInlineDelegate<void(const class FString& SelectedItem, ESelectInfo SelectionType)> OnSelectionChanged;                                // 0x0D98(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_DB8[0x50];                                     // 0x0DB8(0x0050)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UComboBoxString) == 0x000E08, "Wrong size on UComboBoxString");
static_assert(offsetof(UComboBoxString, DefaultOptions) == 0x000110, "Member 'UComboBoxString::DefaultOptions' has a wrong offset!");
static_assert(offsetof(UComboBoxString, SelectedOption) == 0x000120, "Member 'UComboBoxString::SelectedOption' has a wrong offset!");
static_assert(offsetof(UComboBoxString, WidgetStyle) == 0x000130, "Member 'UComboBoxString::WidgetStyle' has a wrong offset!");
static_assert(offsetof(UComboBoxString, ItemStyle) == 0x000520, "Member 'UComboBoxString::ItemStyle' has a wrong offset!");
static_assert(offsetof(UComboBoxString, ContentPadding) == 0x000CE8, "Member 'UComboBoxString::ContentPadding' has a wrong offset!");
static_assert(offsetof(UComboBoxString, MaxListHeight) == 0x000CF8, "Member 'UComboBoxString::MaxListHeight' has a wrong offset!");
static_assert(offsetof(UComboBoxString, HasDownArrow) == 0x000CFC, "Member 'UComboBoxString::HasDownArrow' has a wrong offset!");
static_assert(offsetof(UComboBoxString, EnableGamepadNavigationMode) == 0x000CFD, "Member 'UComboBoxString::EnableGamepadNavigationMode' has a wrong offset!");
static_assert(offsetof(UComboBoxString, Font) == 0x000D00, "Member 'UComboBoxString::Font' has a wrong offset!");
static_assert(offsetof(UComboBoxString, ForegroundColor) == 0x000D58, "Member 'UComboBoxString::ForegroundColor' has a wrong offset!");
static_assert(offsetof(UComboBoxString, bIsFocusable) == 0x000D80, "Member 'UComboBoxString::bIsFocusable' has a wrong offset!");
static_assert(offsetof(UComboBoxString, OnGenerateWidgetEvent) == 0x000D84, "Member 'UComboBoxString::OnGenerateWidgetEvent' has a wrong offset!");
static_assert(offsetof(UComboBoxString, OnSelectionChanged) == 0x000D98, "Member 'UComboBoxString::OnSelectionChanged' has a wrong offset!");
static_assert(offsetof(UComboBoxString, OnOpening) == 0x000DA8, "Member 'UComboBoxString::OnOpening' has a wrong offset!");
...
public:
	...
	struct FRadialBoxSettings                     RadialBoxSettings;                                 // 0x0140(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, Protected, NativeAccessSpecifierProtected)
...
static_assert(offsetof(UDynamicEntryBoxBase, EntryBoxType) == 0x000110, "Member 'UDynamicEntryBoxBase::EntryBoxType' has a wrong offset!");
static_assert(offsetof(UDynamicEntryBoxBase, EntrySpacing) == 0x000114, "Member 'UDynamicEntryBoxBase::EntrySpacing' has a wrong offset!");
static_assert(offsetof(UDynamicEntryBoxBase, SpacingPattern) == 0x000120, "Member 'UDynamicEntryBoxBase::SpacingPattern' has a wrong offset!");
static_assert(offsetof(UDynamicEntryBoxBase, EntrySizeRule) == 0x000130, "Member 'UDynamicEntryBoxBase::EntrySizeRule' has a wrong offset!");
static_assert(offsetof(UDynamicEntryBoxBase, EntryHorizontalAlignment) == 0x000138, "Member 'UDynamicEntryBoxBase::EntryHorizontalAlignment' has a wrong offset!");
static_assert(offsetof(UDynamicEntryBoxBase, EntryVerticalAlignment) == 0x000139, "Member 'UDynamicEntryBoxBase::EntryVerticalAlignment' has a wrong offset!");
static_assert(offsetof(UDynamicEntryBoxBase, MaxElementSize) == 0x00013C, "Member 'UDynamicEntryBoxBase::MaxElementSize' has a wrong offset!");
static_assert(offsetof(UDynamicEntryBoxBase, RadialBoxSettings) == 0x000140, "Member 'UDynamicEntryBoxBase::RadialBoxSettings' has a wrong offset!");
static_assert(offsetof(UDynamicEntryBoxBase, EntryWidgetPool) == 0x000160, "Member 'UDynamicEntryBoxBase::EntryWidgetPool' has a wrong offset!");
...
public:
	...
	bool                                          bReverse;                                          // 0x0138(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(offsetof(UHorizontalBox, bReverse) == 0x000138, "Member 'UHorizontalBox::bReverse' has a wrong offset!");
...
public:
	...
	TMulticastInlineDelegate<void(class FText& Text)> OnTextChanged;                                     // 0x0438(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class FText& Text, ETextCommit CommitMethod)> OnTextCommitted;                                   // 0x0448(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UEditableText) == 0x000468, "Wrong size on UEditableText");
static_assert(offsetof(UEditableText, Text) == 0x000110, "Member 'UEditableText::Text' has a wrong offset!");
static_assert(offsetof(UEditableText, TextDelegate) == 0x000128, "Member 'UEditableText::TextDelegate' has a wrong offset!");
static_assert(offsetof(UEditableText, HintText) == 0x000138, "Member 'UEditableText::HintText' has a wrong offset!");
static_assert(offsetof(UEditableText, HintTextDelegate) == 0x000150, "Member 'UEditableText::HintTextDelegate' has a wrong offset!");
static_assert(offsetof(UEditableText, WidgetStyle) == 0x000160, "Member 'UEditableText::WidgetStyle' has a wrong offset!");
...
static_assert(offsetof(UEditableText, ColorAndOpacity) == 0x0003F8, "Member 'UEditableText::ColorAndOpacity' has a wrong offset!");
...
static_assert(offsetof(UEditableText, ShapedTextOptions) == 0x000433, "Member 'UEditableText::ShapedTextOptions' has a wrong offset!");
...
public:
	...
	TMulticastInlineDelegate<void(class FText& Text)> OnTextChanged;                                     // 0x0A10(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class FText& Text, ETextCommit CommitMethod)> OnTextCommitted;                                   // 0x0A20(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UEditableTextBox) == 0x000A40, "Wrong size on UEditableTextBox");
static_assert(offsetof(UEditableTextBox, Text) == 0x000110, "Member 'UEditableTextBox::Text' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, TextDelegate) == 0x000128, "Member 'UEditableTextBox::TextDelegate' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, WidgetStyle) == 0x000138, "Member 'UEditableTextBox::WidgetStyle' has a wrong offset!");
...
static_assert(offsetof(UEditableTextBox, ForegroundColor) == 0x0009B8, "Member 'UEditableTextBox::ForegroundColor' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, BackgroundColor) == 0x0009C8, "Member 'UEditableTextBox::BackgroundColor' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, ReadOnlyForegroundColor) == 0x0009D8, "Member 'UEditableTextBox::ReadOnlyForegroundColor' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, IsReadOnly) == 0x0009E8, "Member 'UEditableTextBox::IsReadOnly' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, IsPassword) == 0x0009E9, "Member 'UEditableTextBox::IsPassword' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, MinimumDesiredWidth) == 0x0009EC, "Member 'UEditableTextBox::MinimumDesiredWidth' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, Padding) == 0x0009F0, "Member 'UEditableTextBox::Padding' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, IsCaretMovedWhenGainFocus) == 0x000A00, "Member 'UEditableTextBox::IsCaretMovedWhenGainFocus' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, SelectAllTextWhenFocused) == 0x000A01, "Member 'UEditableTextBox::SelectAllTextWhenFocused' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, RevertTextOnEscape) == 0x000A02, "Member 'UEditableTextBox::RevertTextOnEscape' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, ClearKeyboardFocusOnCommit) == 0x000A03, "Member 'UEditableTextBox::ClearKeyboardFocusOnCommit' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, SelectAllTextOnCommit) == 0x000A04, "Member 'UEditableTextBox::SelectAllTextOnCommit' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, AllowContextMenu) == 0x000A05, "Member 'UEditableTextBox::AllowContextMenu' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, KeyboardType) == 0x000A06, "Member 'UEditableTextBox::KeyboardType' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, VirtualKeyboardOptions) == 0x000A07, "Member 'UEditableTextBox::VirtualKeyboardOptions' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, VirtualKeyboardTrigger) == 0x000A08, "Member 'UEditableTextBox::VirtualKeyboardTrigger' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, VirtualKeyboardDismissAction) == 0x000A09, "Member 'UEditableTextBox::VirtualKeyboardDismissAction' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, Justification) == 0x000A0A, "Member 'UEditableTextBox::Justification' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, ShapedTextOptions) == 0x000A0B, "Member 'UEditableTextBox::ShapedTextOptions' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, OnTextChanged) == 0x000A10, "Member 'UEditableTextBox::OnTextChanged' has a wrong offset!");
...
static_assert(sizeof(UGridPanel) == 0x000158, "Wrong size on UGridPanel");
static_assert(offsetof(UGridPanel, ColumnFill) == 0x000128, "Member 'UGridPanel::ColumnFill' has a wrong offset!");
static_assert(offsetof(UGridPanel, RowFill) == 0x000138, "Member 'UGridPanel::RowFill' has a wrong offset!");
...
public:
	...
	TMulticastInlineDelegate<void(const struct FInputChord& SelectedKey)> OnKeySelected;                                     // 0x06D8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void()>              OnIsSelectingKeyChanged;                           // 0x06E8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UInputKeySelector) == 0x000708, "Wrong size on UInputKeySelector");
static_assert(offsetof(UInputKeySelector, WidgetStyle) == 0x000110, "Member 'UInputKeySelector::WidgetStyle' has a wrong offset!");
static_assert(offsetof(UInputKeySelector, TextStyle) == 0x000388, "Member 'UInputKeySelector::TextStyle' has a wrong offset!");
...
static_assert(offsetof(UInputKeySelector, Margin) == 0x000670, "Member 'UInputKeySelector::Margin' has a wrong offset!");
static_assert(offsetof(UInputKeySelector, ColorAndOpacity) == 0x000680, "Member 'UInputKeySelector::ColorAndOpacity' has a wrong offset!");
static_assert(offsetof(UInputKeySelector, KeySelectionText) == 0x000690, "Member 'UInputKeySelector::KeySelectionText' has a wrong offset!");
static_assert(offsetof(UInputKeySelector, NoKeySpecifiedText) == 0x0006A8, "Member 'UInputKeySelector::NoKeySpecifiedText' has a wrong offset!");
static_assert(offsetof(UInputKeySelector, bAllowModifierKeys) == 0x0006C0, "Member 'UInputKeySelector::bAllowModifierKeys' has a wrong offset!");
static_assert(offsetof(UInputKeySelector, bAllowGamepadKeys) == 0x0006C1, "Member 'UInputKeySelector::bAllowGamepadKeys' has a wrong offset!");
static_assert(offsetof(UInputKeySelector, EscapeKeys) == 0x0006C8, "Member 'UInputKeySelector::EscapeKeys' has a wrong offset!");
static_assert(offsetof(UInputKeySelector, OnKeySelected) == 0x0006D8, "Member 'UInputKeySelector::OnKeySelected' has a wrong offset!");
...
static_assert(sizeof(UInvalidationBox) == 0x000140, "Wrong size on UInvalidationBox");
static_assert(offsetof(UInvalidationBox, bCanCache) == 0x000128, "Member 'UInvalidationBox::bCanCache' has a wrong offset!");
static_assert(offsetof(UInvalidationBox, CacheRelativeTransforms) == 0x000129, "Member 'UInvalidationBox::CacheRelativeTransforms' has a wrong offset!");
...
static_assert(offsetof(UListViewBase, EntryWidgetClass) == 0x000110, "Member 'UListViewBase::EntryWidgetClass' has a wrong offset!");
static_assert(offsetof(UListViewBase, WheelScrollMultiplier) == 0x000118, "Member 'UListViewBase::WheelScrollMultiplier' has a wrong offset!");
static_assert(offsetof(UListViewBase, bEnableScrollAnimation) == 0x00011C, "Member 'UListViewBase::bEnableScrollAnimation' has a wrong offset!");
static_assert(offsetof(UListViewBase, bEnableFixedLineOffset) == 0x00011D, "Member 'UListViewBase::bEnableFixedLineOffset' has a wrong offset!");
static_assert(offsetof(UListViewBase, FixedLineScrollOffset) == 0x000120, "Member 'UListViewBase::FixedLineScrollOffset' has a wrong offset!");
static_assert(offsetof(UListViewBase, BP_OnEntryGenerated) == 0x000128, "Member 'UListViewBase::BP_OnEntryGenerated' has a wrong offset!");
...
static_assert(offsetof(UListViewBase, EntryWidgetPool) == 0x000148, "Member 'UListViewBase::EntryWidgetPool' has a wrong offset!");
...
static_assert(sizeof(UListView) == 0x000370, "Wrong size on UListView");
static_assert(offsetof(UListView, Orientation) == 0x0002E0, "Member 'UListView::Orientation' has a wrong offset!");
static_assert(offsetof(UListView, SelectionMode) == 0x0002E1, "Member 'UListView::SelectionMode' has a wrong offset!");
static_assert(offsetof(UListView, ConsumeMouseWheel) == 0x0002E2, "Member 'UListView::ConsumeMouseWheel' has a wrong offset!");
static_assert(offsetof(UListView, bClearSelectionOnClick) == 0x0002E3, "Member 'UListView::bClearSelectionOnClick' has a wrong offset!");
static_assert(offsetof(UListView, bIsFocusable) == 0x0002E4, "Member 'UListView::bIsFocusable' has a wrong offset!");
static_assert(offsetof(UListView, EntrySpacing) == 0x0002E8, "Member 'UListView::EntrySpacing' has a wrong offset!");
static_assert(offsetof(UListView, bReturnFocusToSelection) == 0x0002EC, "Member 'UListView::bReturnFocusToSelection' has a wrong offset!");
static_assert(offsetof(UListView, ListItems) == 0x0002F0, "Member 'UListView::ListItems' has a wrong offset!");
static_assert(offsetof(UListView, BP_OnEntryInitialized) == 0x000310, "Member 'UListView::BP_OnEntryInitialized' has a wrong offset!");
static_assert(offsetof(UListView, BP_OnItemClicked) == 0x000320, "Member 'UListView::BP_OnItemClicked' has a wrong offset!");
static_assert(offsetof(UListView, BP_OnItemDoubleClicked) == 0x000330, "Member 'UListView::BP_OnItemDoubleClicked' has a wrong offset!");
static_assert(offsetof(UListView, BP_OnItemIsHoveredChanged) == 0x000340, "Member 'UListView::BP_OnItemIsHoveredChanged' has a wrong offset!");
static_assert(offsetof(UListView, BP_OnItemSelectionChanged) == 0x000350, "Member 'UListView::BP_OnItemSelectionChanged' has a wrong offset!");
static_assert(offsetof(UListView, BP_OnItemScrolledIntoView) == 0x000360, "Member 'UListView::BP_OnItemScrolledIntoView' has a wrong offset!");
...
static_assert(offsetof(UMenuAnchor, MenuClass) == 0x000128, "Member 'UMenuAnchor::MenuClass' has a wrong offset!");
static_assert(offsetof(UMenuAnchor, OnGetMenuContentEvent) == 0x000130, "Member 'UMenuAnchor::OnGetMenuContentEvent' has a wrong offset!");
static_assert(offsetof(UMenuAnchor, OnGetUserMenuContentEvent) == 0x000140, "Member 'UMenuAnchor::OnGetUserMenuContentEvent' has a wrong offset!");
...
public:
	...
	TMulticastInlineDelegate<void(class FText& Text)> OnTextChanged;                                     // 0x0448(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class FText& Text, ETextCommit CommitMethod)> OnTextCommitted;                                   // 0x0458(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMultiLineEditableText) == 0x000478, "Wrong size on UMultiLineEditableText");
static_assert(offsetof(UMultiLineEditableText, Text) == 0x000130, "Member 'UMultiLineEditableText::Text' has a wrong offset!");
static_assert(offsetof(UMultiLineEditableText, HintText) == 0x000148, "Member 'UMultiLineEditableText::HintText' has a wrong offset!");
static_assert(offsetof(UMultiLineEditableText, HintTextDelegate) == 0x000160, "Member 'UMultiLineEditableText::HintTextDelegate' has a wrong offset!");
static_assert(offsetof(UMultiLineEditableText, WidgetStyle) == 0x000170, "Member 'UMultiLineEditableText::WidgetStyle' has a wrong offset!");
...
static_assert(offsetof(UMultiLineEditableText, SelectAllTextWhenFocused) == 0x000440, "Member 'UMultiLineEditableText::SelectAllTextWhenFocused' has a wrong offset!");
static_assert(offsetof(UMultiLineEditableText, ClearTextSelectionOnFocusLoss) == 0x000441, "Member 'UMultiLineEditableText::ClearTextSelectionOnFocusLoss' has a wrong offset!");
static_assert(offsetof(UMultiLineEditableText, RevertTextOnEscape) == 0x000442, "Member 'UMultiLineEditableText::RevertTextOnEscape' has a wrong offset!");
static_assert(offsetof(UMultiLineEditableText, ClearKeyboardFocusOnCommit) == 0x000443, "Member 'UMultiLineEditableText::ClearKeyboardFocusOnCommit' has a wrong offset!");
static_assert(offsetof(UMultiLineEditableText, AllowContextMenu) == 0x000444, "Member 'UMultiLineEditableText::AllowContextMenu' has a wrong offset!");
static_assert(offsetof(UMultiLineEditableText, VirtualKeyboardOptions) == 0x000445, "Member 'UMultiLineEditableText::VirtualKeyboardOptions' has a wrong offset!");
static_assert(offsetof(UMultiLineEditableText, VirtualKeyboardDismissAction) == 0x000446, "Member 'UMultiLineEditableText::VirtualKeyboardDismissAction' has a wrong offset!");
static_assert(offsetof(UMultiLineEditableText, OnTextChanged) == 0x000448, "Member 'UMultiLineEditableText::OnTextChanged' has a wrong offset!");
...
public:
	...
	TMulticastInlineDelegate<void(class FText& Text)> OnTextChanged;                                     // 0x0C70(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class FText& Text, ETextCommit CommitMethod)> OnTextCommitted;                                   // 0x0C80(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UMultiLineEditableTextBox, Text) == 0x000130, "Member 'UMultiLineEditableTextBox::Text' has a wrong offset!");
static_assert(offsetof(UMultiLineEditableTextBox, HintText) == 0x000148, "Member 'UMultiLineEditableTextBox::HintText' has a wrong offset!");
static_assert(offsetof(UMultiLineEditableTextBox, HintTextDelegate) == 0x000160, "Member 'UMultiLineEditableTextBox::HintTextDelegate' has a wrong offset!");
static_assert(offsetof(UMultiLineEditableTextBox, WidgetStyle) == 0x000170, "Member 'UMultiLineEditableTextBox::WidgetStyle' has a wrong offset!");
...
static_assert(offsetof(UMultiLineEditableTextBox, bIsReadOnly) == 0x000BD8, "Member 'UMultiLineEditableTextBox::bIsReadOnly' has a wrong offset!");
static_assert(offsetof(UMultiLineEditableTextBox, AllowContextMenu) == 0x000BD9, "Member 'UMultiLineEditableTextBox::AllowContextMenu' has a wrong offset!");
static_assert(offsetof(UMultiLineEditableTextBox, VirtualKeyboardOptions) == 0x000BDA, "Member 'UMultiLineEditableTextBox::VirtualKeyboardOptions' has a wrong offset!");
static_assert(offsetof(UMultiLineEditableTextBox, VirtualKeyboardDismissAction) == 0x000BDB, "Member 'UMultiLineEditableTextBox::VirtualKeyboardDismissAction' has a wrong offset!");
static_assert(offsetof(UMultiLineEditableTextBox, Style) == 0x000BE0, "Member 'UMultiLineEditableTextBox::Style' has a wrong offset!");
static_assert(offsetof(UMultiLineEditableTextBox, Font) == 0x000BE8, "Member 'UMultiLineEditableTextBox::Font' has a wrong offset!");
static_assert(offsetof(UMultiLineEditableTextBox, ForegroundColor) == 0x000C40, "Member 'UMultiLineEditableTextBox::ForegroundColor' has a wrong offset!");
static_assert(offsetof(UMultiLineEditableTextBox, BackgroundColor) == 0x000C50, "Member 'UMultiLineEditableTextBox::BackgroundColor' has a wrong offset!");
static_assert(offsetof(UMultiLineEditableTextBox, ReadOnlyForegroundColor) == 0x000C60, "Member 'UMultiLineEditableTextBox::ReadOnlyForegroundColor' has a wrong offset!");
static_assert(offsetof(UMultiLineEditableTextBox, OnTextChanged) == 0x000C70, "Member 'UMultiLineEditableTextBox::OnTextChanged' has a wrong offset!");
static_assert(offsetof(UMultiLineEditableTextBox, OnTextCommitted) == 0x000C80, "Member 'UMultiLineEditableTextBox::OnTextCommitted' has a wrong offset!");
...
static_assert(sizeof(UNamedSlot) == 0x000138, "Wrong size on UNamedSlot");
...
static_assert(sizeof(UNativeWidgetHost) == 0x000120, "Wrong size on UNativeWidgetHost");
...
static_assert(sizeof(UProgressBar) == 0x000320, "Wrong size on UProgressBar");
static_assert(offsetof(UProgressBar, WidgetStyle) == 0x000110, "Member 'UProgressBar::WidgetStyle' has a wrong offset!");
static_assert(offsetof(UProgressBar, Style) == 0x0002B0, "Member 'UProgressBar::Style' has a wrong offset!");
static_assert(offsetof(UProgressBar, BackgroundImage) == 0x0002B8, "Member 'UProgressBar::BackgroundImage' has a wrong offset!");
static_assert(offsetof(UProgressBar, FillImage) == 0x0002C0, "Member 'UProgressBar::FillImage' has a wrong offset!");
static_assert(offsetof(UProgressBar, MarqueeImage) == 0x0002C8, "Member 'UProgressBar::MarqueeImage' has a wrong offset!");
static_assert(offsetof(UProgressBar, Percent) == 0x0002D0, "Member 'UProgressBar::Percent' has a wrong offset!");
static_assert(offsetof(UProgressBar, BarFillType) == 0x0002D4, "Member 'UProgressBar::BarFillType' has a wrong offset!");
static_assert(offsetof(UProgressBar, bIsMarquee) == 0x0002D5, "Member 'UProgressBar::bIsMarquee' has a wrong offset!");
static_assert(offsetof(UProgressBar, BorderPadding) == 0x0002D8, "Member 'UProgressBar::BorderPadding' has a wrong offset!");
static_assert(offsetof(UProgressBar, PercentDelegate) == 0x0002E0, "Member 'UProgressBar::PercentDelegate' has a wrong offset!");
static_assert(offsetof(UProgressBar, FillColorAndOpacity) == 0x0002F0, "Member 'UProgressBar::FillColorAndOpacity' has a wrong offset!");
static_assert(offsetof(UProgressBar, FillColorAndOpacityDelegate) == 0x000300, "Member 'UProgressBar::FillColorAndOpacityDelegate' has a wrong offset!");
...
static_assert(offsetof(URetainerBox, bRetainRender) == 0x000128, "Member 'URetainerBox::bRetainRender' has a wrong offset!");
static_assert(offsetof(URetainerBox, RenderOnInvalidation) == 0x000129, "Member 'URetainerBox::RenderOnInvalidation' has a wrong offset!");
static_assert(offsetof(URetainerBox, RenderOnPhase) == 0x00012A, "Member 'URetainerBox::RenderOnPhase' has a wrong offset!");
static_assert(offsetof(URetainerBox, Phase) == 0x00012C, "Member 'URetainerBox::Phase' has a wrong offset!");
static_assert(offsetof(URetainerBox, PhaseCount) == 0x000130, "Member 'URetainerBox::PhaseCount' has a wrong offset!");
...
public:
	...
	TArray<TSubclassOf<class URichTextBlockDecorator>> DecoratorClasses;                                  // 0x0150(0x0010)(Edit, ZeroConstructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
...
static_assert(sizeof(URichTextBlock) == 0x000680, "Wrong size on URichTextBlock");
static_assert(offsetof(URichTextBlock, Text) == 0x000130, "Member 'URichTextBlock::Text' has a wrong offset!");
static_assert(offsetof(URichTextBlock, TextStyleSet) == 0x000148, "Member 'URichTextBlock::TextStyleSet' has a wrong offset!");
static_assert(offsetof(URichTextBlock, DecoratorClasses) == 0x000150, "Member 'URichTextBlock::DecoratorClasses' has a wrong offset!");
static_assert(offsetof(URichTextBlock, bOverrideDefaultStyle) == 0x000160, "Member 'URichTextBlock::bOverrideDefaultStyle' has a wrong offset!");
static_assert(offsetof(URichTextBlock, DefaultTextStyleOverride) == 0x000168, "Member 'URichTextBlock::DefaultTextStyleOverride' has a wrong offset!");
static_assert(offsetof(URichTextBlock, MinDesiredWidth) == 0x0003D8, "Member 'URichTextBlock::MinDesiredWidth' has a wrong offset!");
static_assert(offsetof(URichTextBlock, TextTransformPolicy) == 0x0003DC, "Member 'URichTextBlock::TextTransformPolicy' has a wrong offset!");
static_assert(offsetof(URichTextBlock, DefaultTextStyle) == 0x0003E0, "Member 'URichTextBlock::DefaultTextStyle' has a wrong offset!");
static_assert(offsetof(URichTextBlock, InstanceDecorators) == 0x000650, "Member 'URichTextBlock::InstanceDecorators' has a wrong offset!");
...
static_assert(sizeof(USafeZone) == 0x000140, "Wrong size on USafeZone");
static_assert(offsetof(USafeZone, PadLeft) == 0x000128, "Member 'USafeZone::PadLeft' has a wrong offset!");
static_assert(offsetof(USafeZone, PadRight) == 0x000129, "Member 'USafeZone::PadRight' has a wrong offset!");
static_assert(offsetof(USafeZone, PadTop) == 0x00012A, "Member 'USafeZone::PadTop' has a wrong offset!");
static_assert(offsetof(USafeZone, PadBottom) == 0x00012B, "Member 'USafeZone::PadBottom' has a wrong offset!");
...
static_assert(sizeof(UScaleBox) == 0x000148, "Wrong size on UScaleBox");
static_assert(offsetof(UScaleBox, Stretch) == 0x000128, "Member 'UScaleBox::Stretch' has a wrong offset!");
static_assert(offsetof(UScaleBox, StretchDirection) == 0x000129, "Member 'UScaleBox::StretchDirection' has a wrong offset!");
static_assert(offsetof(UScaleBox, UserSpecifiedScale) == 0x00012C, "Member 'UScaleBox::UserSpecifiedScale' has a wrong offset!");
static_assert(offsetof(UScaleBox, IgnoreInheritedScale) == 0x000130, "Member 'UScaleBox::IgnoreInheritedScale' has a wrong offset!");
...
static_assert(sizeof(UScrollBar) == 0x000618, "Wrong size on UScrollBar");
static_assert(offsetof(UScrollBar, WidgetStyle) == 0x000110, "Member 'UScrollBar::WidgetStyle' has a wrong offset!");
static_assert(offsetof(UScrollBar, Style) == 0x0005E0, "Member 'UScrollBar::Style' has a wrong offset!");
static_assert(offsetof(UScrollBar, bAlwaysShowScrollBar) == 0x0005E8, "Member 'UScrollBar::bAlwaysShowScrollBar' has a wrong offset!");
static_assert(offsetof(UScrollBar, bAlwaysShowScrollbarTrack) == 0x0005E9, "Member 'UScrollBar::bAlwaysShowScrollbarTrack' has a wrong offset!");
static_assert(offsetof(UScrollBar, Orientation) == 0x0005EA, "Member 'UScrollBar::Orientation' has a wrong offset!");
static_assert(offsetof(UScrollBar, Thickness) == 0x0005EC, "Member 'UScrollBar::Thickness' has a wrong offset!");
static_assert(offsetof(UScrollBar, Padding) == 0x0005F4, "Member 'UScrollBar::Padding' has a wrong offset!");
...
static_assert(offsetof(USizeBox, WidthOverride) == 0x000138, "Member 'USizeBox::WidthOverride' has a wrong offset!");
static_assert(offsetof(USizeBox, HeightOverride) == 0x00013C, "Member 'USizeBox::HeightOverride' has a wrong offset!");
static_assert(offsetof(USizeBox, MinDesiredWidth) == 0x000140, "Member 'USizeBox::MinDesiredWidth' has a wrong offset!");
static_assert(offsetof(USizeBox, MinDesiredHeight) == 0x000144, "Member 'USizeBox::MinDesiredHeight' has a wrong offset!");
static_assert(offsetof(USizeBox, MaxDesiredWidth) == 0x000148, "Member 'USizeBox::MaxDesiredWidth' has a wrong offset!");
static_assert(offsetof(USizeBox, MaxDesiredHeight) == 0x00014C, "Member 'USizeBox::MaxDesiredHeight' has a wrong offset!");
static_assert(offsetof(USizeBox, MinAspectRatio) == 0x000150, "Member 'USizeBox::MinAspectRatio' has a wrong offset!");
static_assert(offsetof(USizeBox, MaxAspectRatio) == 0x000154, "Member 'USizeBox::MaxAspectRatio' has a wrong offset!");
...
static_assert(sizeof(USlider) == 0x000500, "Wrong size on USlider");
static_assert(offsetof(USlider, Value) == 0x000110, "Member 'USlider::Value' has a wrong offset!");
static_assert(offsetof(USlider, ValueDelegate) == 0x000114, "Member 'USlider::ValueDelegate' has a wrong offset!");
static_assert(offsetof(USlider, MinValue) == 0x000124, "Member 'USlider::MinValue' has a wrong offset!");
static_assert(offsetof(USlider, MaxValue) == 0x000128, "Member 'USlider::MaxValue' has a wrong offset!");
...
static_assert(offsetof(USlider, OnMouseCaptureEnd) == 0x0004B0, "Member 'USlider::OnMouseCaptureEnd' has a wrong offset!");
static_assert(offsetof(USlider, OnControllerCaptureBegin) == 0x0004C0, "Member 'USlider::OnControllerCaptureBegin' has a wrong offset!");
static_assert(offsetof(USlider, OnControllerCaptureEnd) == 0x0004D0, "Member 'USlider::OnControllerCaptureEnd' has a wrong offset!");
static_assert(offsetof(USlider, OnValueChanged) == 0x0004E0, "Member 'USlider::OnValueChanged' has a wrong offset!");
...
static_assert(sizeof(USpacer) == 0x000128, "Wrong size on USpacer");
static_assert(offsetof(USpacer, Size) == 0x000110, "Member 'USpacer::Size' has a wrong offset!");

// Class UMG.SpinBox
// 0x0418 (0x0528 - 0x0110)
...
public:
	...
	TMulticastInlineDelegate<void(float InValue)> OnValueChanged;                                    // 0x04C0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(float InValue, ETextCommit CommitMethod)> OnValueCommitted;                                  // 0x04D0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void()>              OnBeginSliderMovement;                             // 0x04E0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(float InValue)> OnEndSliderMovement;                               // 0x04F0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         bOverride_MinValue : 1;                            // 0x0500(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bOverride_MaxValue : 1;                            // 0x0500(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bOverride_MinSliderValue : 1;                      // 0x0500(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bOverride_MaxSliderValue : 1;                      // 0x0500(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
...
static_assert(sizeof(USpinBox) == 0x000528, "Wrong size on USpinBox");
static_assert(offsetof(USpinBox, Value) == 0x000110, "Member 'USpinBox::Value' has a wrong offset!");
static_assert(offsetof(USpinBox, ValueDelegate) == 0x000114, "Member 'USpinBox::ValueDelegate' has a wrong offset!");
static_assert(offsetof(USpinBox, WidgetStyle) == 0x000128, "Member 'USpinBox::WidgetStyle' has a wrong offset!");
static_assert(offsetof(USpinBox, Style) == 0x000410, "Member 'USpinBox::Style' has a wrong offset!");
static_assert(offsetof(USpinBox, MinFractionalDigits) == 0x000418, "Member 'USpinBox::MinFractionalDigits' has a wrong offset!");
static_assert(offsetof(USpinBox, MaxFractionalDigits) == 0x00041C, "Member 'USpinBox::MaxFractionalDigits' has a wrong offset!");
static_assert(offsetof(USpinBox, bAlwaysUsesDeltaSnap) == 0x000420, "Member 'USpinBox::bAlwaysUsesDeltaSnap' has a wrong offset!");
static_assert(offsetof(USpinBox, Delta) == 0x000424, "Member 'USpinBox::Delta' has a wrong offset!");
static_assert(offsetof(USpinBox, SliderExponent) == 0x000428, "Member 'USpinBox::SliderExponent' has a wrong offset!");
static_assert(offsetof(USpinBox, Font) == 0x000430, "Member 'USpinBox::Font' has a wrong offset!");
static_assert(offsetof(USpinBox, Justification) == 0x000488, "Member 'USpinBox::Justification' has a wrong offset!");
static_assert(offsetof(USpinBox, MinDesiredWidth) == 0x00048C, "Member 'USpinBox::MinDesiredWidth' has a wrong offset!");
static_assert(offsetof(USpinBox, ClearKeyboardFocusOnCommit) == 0x000490, "Member 'USpinBox::ClearKeyboardFocusOnCommit' has a wrong offset!");
static_assert(offsetof(USpinBox, SelectAllTextOnCommit) == 0x000491, "Member 'USpinBox::SelectAllTextOnCommit' has a wrong offset!");
static_assert(offsetof(USpinBox, ForegroundColor) == 0x000498, "Member 'USpinBox::ForegroundColor' has a wrong offset!");
static_assert(offsetof(USpinBox, OnValueChanged) == 0x0004C0, "Member 'USpinBox::OnValueChanged' has a wrong offset!");
static_assert(offsetof(USpinBox, OnValueCommitted) == 0x0004D0, "Member 'USpinBox::OnValueCommitted' has a wrong offset!");
static_assert(offsetof(USpinBox, OnBeginSliderMovement) == 0x0004E0, "Member 'USpinBox::OnBeginSliderMovement' has a wrong offset!");
static_assert(offsetof(USpinBox, OnEndSliderMovement) == 0x0004F0, "Member 'USpinBox::OnEndSliderMovement' has a wrong offset!");
static_assert(offsetof(USpinBox, MinValue) == 0x000504, "Member 'USpinBox::MinValue' has a wrong offset!");
static_assert(offsetof(USpinBox, MaxValue) == 0x000508, "Member 'USpinBox::MaxValue' has a wrong offset!");
static_assert(offsetof(USpinBox, MinSliderValue) == 0x00050C, "Member 'USpinBox::MinSliderValue' has a wrong offset!");
static_assert(offsetof(USpinBox, MaxSliderValue) == 0x000510, "Member 'USpinBox::MaxSliderValue' has a wrong offset!");

// Class UMG.SpUISettings
// 0x0008 (0x0030 - 0x0028)
class USpUISettings final : public UObject
{
public:
	int32                                         UIAnimationRate;                                   // 0x0028(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2C[0x4];                                       // 0x002C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"SpUISettings">();
	}
	static class USpUISettings* GetDefaultObj()
	{
		return GetDefaultObjImpl<USpUISettings>();
	}
};
static_assert(alignof(USpUISettings) == 0x000008, "Wrong alignment on USpUISettings");
static_assert(sizeof(USpUISettings) == 0x000030, "Wrong size on USpUISettings");
static_assert(offsetof(USpUISettings, UIAnimationRate) == 0x000028, "Member 'USpUISettings::UIAnimationRate' has a wrong offset!");
...
static_assert(offsetof(UTextBlock, Text) == 0x000130, "Member 'UTextBlock::Text' has a wrong offset!");
static_assert(offsetof(UTextBlock, TextDelegate) == 0x000148, "Member 'UTextBlock::TextDelegate' has a wrong offset!");
static_assert(offsetof(UTextBlock, ColorAndOpacity) == 0x000158, "Member 'UTextBlock::ColorAndOpacity' has a wrong offset!");
static_assert(offsetof(UTextBlock, ColorAndOpacityDelegate) == 0x000180, "Member 'UTextBlock::ColorAndOpacityDelegate' has a wrong offset!");
static_assert(offsetof(UTextBlock, Font) == 0x000190, "Member 'UTextBlock::Font' has a wrong offset!");
...
static_assert(offsetof(UTextBlock, TextTransformPolicy) == 0x00029E, "Member 'UTextBlock::TextTransformPolicy' has a wrong offset!");
static_assert(offsetof(UTextBlock, bSimpleTextMode) == 0x00029F, "Member 'UTextBlock::bSimpleTextMode' has a wrong offset!");
...
static_assert(sizeof(UThrobber) == 0x0001B8, "Wrong size on UThrobber");
static_assert(offsetof(UThrobber, NumberOfPieces) == 0x000110, "Member 'UThrobber::NumberOfPieces' has a wrong offset!");
static_assert(offsetof(UThrobber, bAnimateHorizontally) == 0x000114, "Member 'UThrobber::bAnimateHorizontally' has a wrong offset!");
static_assert(offsetof(UThrobber, bAnimateVertically) == 0x000115, "Member 'UThrobber::bAnimateVertically' has a wrong offset!");
static_assert(offsetof(UThrobber, bAnimateOpacity) == 0x000116, "Member 'UThrobber::bAnimateOpacity' has a wrong offset!");
static_assert(offsetof(UThrobber, PieceImage) == 0x000118, "Member 'UThrobber::PieceImage' has a wrong offset!");
...
static_assert(sizeof(UTileView) == 0x000390, "Wrong size on UTileView");
static_assert(offsetof(UTileView, EntryHeight) == 0x000370, "Member 'UTileView::EntryHeight' has a wrong offset!");
static_assert(offsetof(UTileView, EntryWidth) == 0x000374, "Member 'UTileView::EntryWidth' has a wrong offset!");
static_assert(offsetof(UTileView, TileAlignment) == 0x000378, "Member 'UTileView::TileAlignment' has a wrong offset!");
static_assert(offsetof(UTileView, bWrapHorizontalNavigation) == 0x000379, "Member 'UTileView::bWrapHorizontalNavigation' has a wrong offset!");
...
static_assert(sizeof(UTreeView) == 0x0003C8, "Wrong size on UTreeView");
static_assert(offsetof(UTreeView, BP_OnGetItemChildren) == 0x000380, "Member 'UTreeView::BP_OnGetItemChildren' has a wrong offset!");
static_assert(offsetof(UTreeView, BP_OnItemExpansionChanged) == 0x000390, "Member 'UTreeView::BP_OnItemExpansionChanged' has a wrong offset!");
...
static_assert(offsetof(UUniformGridPanel, SlotPadding) == 0x000128, "Member 'UUniformGridPanel::SlotPadding' has a wrong offset!");
...
static_assert(offsetof(UVerticalBox, bReverse) == 0x000138, "Member 'UVerticalBox::bReverse' has a wrong offset!");
...
static_assert(offsetof(UVerticalBoxSlot, bIsScalable) == 0x00005A, "Member 'UVerticalBoxSlot::bIsScalable' has a wrong offset!");
...
static_assert(sizeof(UWidgetSwitcher) == 0x000140, "Wrong size on UWidgetSwitcher");
static_assert(offsetof(UWidgetSwitcher, ActiveWidgetIndex) == 0x000128, "Member 'UWidgetSwitcher::ActiveWidgetIndex' has a wrong offset!");
...
static_assert(sizeof(UWindowTitleBarArea) == 0x000148, "Wrong size on UWindowTitleBarArea");
static_assert(offsetof(UWindowTitleBarArea, bWindowButtonsEnabled) == 0x000128, "Member 'UWindowTitleBarArea::bWindowButtonsEnabled' has a wrong offset!");
static_assert(offsetof(UWindowTitleBarArea, bDoubleClickTogglesFullscreen) == 0x000129, "Member 'UWindowTitleBarArea::bDoubleClickTogglesFullscreen' has a wrong offset!");
...
static_assert(offsetof(UWrapBox, InnerSlotPadding) == 0x000128, "Member 'UWrapBox::InnerSlotPadding' has a wrong offset!");
static_assert(offsetof(UWrapBox, WrapWidth) == 0x000130, "Member 'UWrapBox::WrapWidth' has a wrong offset!");
static_assert(offsetof(UWrapBox, WrapSize) == 0x000134, "Member 'UWrapBox::WrapSize' has a wrong offset!");
static_assert(offsetof(UWrapBox, bExplicitWrapWidth) == 0x000138, "Member 'UWrapBox::bExplicitWrapWidth' has a wrong offset!");
static_assert(offsetof(UWrapBox, bExplicitWrapSize) == 0x000139, "Member 'UWrapBox::bExplicitWrapSize' has a wrong offset!");
static_assert(offsetof(UWrapBox, Orientation) == 0x00013A, "Member 'UWrapBox::Orientation' has a wrong offset!");
